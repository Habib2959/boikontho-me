<script lang="ts">
	...
	let booklist = '';
	const handleSubmit = () => {
		console.log(mobileOrEmail, booklist);
		goto('/success');
	};
</script>

<section class="flex items-center justify-center mt-[120px] lg:mt-0 lg:min-h-screen">
	<div class="container mx-auto w-[90%] lg:w-[100%]">
		...
		>
			<form on:submit|preventDefault={handleSubmit}>
				...
				<textarea
					class="mt-3 px-3 py-2 bg-white border shadow-sm border-[#e9e7e7] placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
