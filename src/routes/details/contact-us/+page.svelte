...
<div class="mb-3 md:mb-6 py-5 bg-btnColor text-[#fff]">
	<h1 class="text-2xl font-bold text-center lg:text-5xl">FEEL FREE TO ASK BOIKONTHO</h1>
</div>
	...
	<div class="container mx-auto">
		<div class="grid md:grid-cols-2">
			<div class="md:order-last">
				<div
					class="px-3 py-2 bg-white border shadow-lg border-slate-100 w-[90%] md:w-full rounded-md mx-auto"
				>
			...
			<div class="w-[90%] md:w-full mx-auto">
				<div class="mt-5">
					...
					<p><span>Email :</span><a href="/">mail@hackules.com</a></p>
