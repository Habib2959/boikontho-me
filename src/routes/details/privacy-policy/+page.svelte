<section class="mt-3 md:mt-6 md:mx-2 lg:mx-4 xl:mx-0 2xl:min-h-[58vh] 2xl:flex 2xl:items-center">
	<div class="container mx-auto w-[90%] md:w-full">
		<div class="border-b-2 border-btnColor mb-3 hack-terms-title pb-[1px]">
			<h1 class="text-lg font-bold lg:text-2xl bg-btnColor text-[#fff] py-1 pr-10 md:pr-16 pl-1">
				Privacy Policy for Boikontho.com
			</h1>
		</div>
		<ol class="list-decimal mx-auto w-[90%] mb-3">
			<li>
				At Boikontho, accessible from boikontho.com, one of our main priorities is the privacy of
				our visitors. This Privacy Policy document contains types of information that is collected
				and recorded by Boikontho and how we use it.
			</li>
			<li>
			...
			<li>
				...
				website with regards to the information that they shared and/or collect in Boikontho. This
		...
		<ol class="list-decimal mx-auto w-[90%] mb-3">
			<li>
				Boikontho follows a standard procedure of using log files. These files log visitors when
		...
		<ol class="list-decimal mx-auto w-[90%] mb-3">
			<li>
				Like any other website, Boikontho uses 'cookies'. These cookies are used to store
		...
		<ol class="list-decimal mx-auto w-[90%] mb-3">
			...
			<li>
				...
				Beacons that are used in their respective advertisements and links that appear on Boikontho,
			...
			<li>
				Note that Boikontho has no access to or control over these cookies that are used by
		...
		<ol class="list-decimal mx-auto w-[90%] mb-3">
			<li>
				Boikontho's Privacy Policy does not apply to other advertisers or websites. Thus, we are
		...
		<div class="border-b-2 border-btnColor mb-3 hack-terms-title pb-[1px]">
			<h1 class="text-lg font-bold lg:text-2xl bg-btnColor text-[#fff] py-1 pr-10 md:pr-20 pl-1">
		...
		<ol class="list-decimal mx-auto w-[90%] mb-3">
			...
			<li>
				Boikontho does not knowingly collect any Personal Identifiable Information from children
